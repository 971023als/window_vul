...
$jsonResultPath = "$($dirs.Result)\W-Window-$computerName-audit_results.json"
$auditParams | ConvertTo-Json -Depth 3 | Out-File -FilePath $jsonResultPath

Write-Host "Audit results saved to $jsonResultPath"
